...
for x in jest functional; do
  ...
  node scripts/ingest_coverage.js --verbose --path ${COVERAGE_SUMMARY_FILE} --vcsInfoPath ./VCS_INFO.txt --teamAssignments src/dev/code_coverage/ingest_coverage/team_assignment/team_assignments.txt
done
